...
.. code-block:: bash
    ...
    fastapi-mvc available under: http://api-container.192.168.49.2.nip.io/
...
.. code-block:: bash
    ...
    ...
    Kubernetes cluster ready
    FastAPI available under: http://api-container.192.168.49.2.nip.io/
    You can delete dev-env by issuing: make clean
    vagrant@ubuntu-focal:/syncd$ kubectl get all -n api-container
    NAME                                                     READY   STATUS    RESTARTS   AGE
    pod/api-container-7f4dd8dc7f-p2kr7                1/1     Running   0          55s
    ...
    vagrant@ubuntu-focal:/syncd$ curl http://api-container.192.168.49.2.nip.io/api/ready
    {"status":"ok"}
Documentation
-------------
